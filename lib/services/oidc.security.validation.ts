...
export class OidcSecurityValidation {
    ...
    validate_signature_id_token(idToken: any, jwtkeys: any): boolean {
        console.log('id_token from server', idToken);
        console.log('jwkeys from server', jwtkeys);
        ...
        if (!headerData.hasOwnProperty('kid')) {
            ...
            // kty	"RSA" use "sig"
            console.log('One key present in jwkeys');
            ...
            console.log('Amount of matching keys: ', amountOfMatchingKeys);
            ...
            if (amountOfMatchingKeys === 0) {
                ...
                for (const key of jwtkeys.keys) {
                    console.log('===== Compare =====')
                    console.log('key: ', key)
                    console.log('jwtkeys: ', jwtkeys.keys)
                    console.log('===================')
                    if ((key.kty as string) === 'RSA' && (key.use as string) === 'sig') {
            ...
            console.log('More keys found en jwks')
